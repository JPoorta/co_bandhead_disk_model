...
stel_parameter_dict = {'B275': [7.2, 12750, 3.44, 9.5, 11300., 100, 3.8, 7.41, -11.2],
                       'B331': [10.0, 13000, 4.13, 18.7, 2700, 100, 4.6, 13.3, 13.9],
                       'B243': [4.2, 11900, 3.78, 4.6, 2700., 100, 4.7, 7.92, 20.2],
                       'B268': [4.5, 11300, 3.78, 5.6, 2700., 100, 4.6, 7.51, 4.3],
                       'B163': [6.0, 8250, 3.63, 8.7, 2700., 100, 4.0, 13.21, 0.0],
                       }
